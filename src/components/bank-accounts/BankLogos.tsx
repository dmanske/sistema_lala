...
export const BANK_PRESETS = [
    { id: 'nubank', name: 'Nubank', color: '#8A05BE', imageUrl: 'https://cdn.simpleicons.org/nubank/8A05BE' },
    { id: 'inter', name: 'Inter', color: '#FF7A00', imageUrl: 'https://cdn.simpleicons.org/inter/FF7A00' },
    { id: 'itau', name: 'Itaú', color: '#EC7000', imageUrl: 'https://cdn.simpleicons.org/itau/EC7000' },
    { id: 'bradesco', name: 'Bradesco', color: '#CC092F', imageUrl: 'https://cdn.simpleicons.org/bradesco/CC092F' },
    { id: 'santander', name: 'Santander', color: '#EC0000', imageUrl: 'https://cdn.simpleicons.org/santander/EC0000' },
    { id: 'bb', name: 'Banco do Brasil', color: '#003882', imageUrl: 'https://cdn.simpleicons.org/bancodobrasil/003882' },
    { id: 'caixa', name: 'Caixa Econômica', color: '#0066B3' },
    { id: 'c6', name: 'C6 Bank', color: '#242424', imageUrl: 'https://cdn.simpleicons.org/c6bank/242424' },
    { id: 'btg', name: 'BTG Pactual', color: '#1A1A1A', imageUrl: 'https://cdn.simpleicons.org/btgpactual/1A1A1A' },
    { id: 'safra', name: 'Banco Safra', color: '#003366' },
    { id: 'original', name: 'Banco Original', color: '#00D959' },
    { id: 'sicoob', name: 'Sicoob', color: '#00A859' },
    { id: 'sicredi', name: 'Sicredi', color: '#006B3F' },
    { id: 'neon', name: 'Neon', color: '#00C5FF', imageUrl: 'https://cdn.simpleicons.org/neon/00C5FF' },
    { id: 'next', name: 'Banco Next', color: '#00D959' },
    { id: 'will', name: 'Will Bank', color: '#FF6B00' },
    { id: 'picpay', name: 'PicPay', color: '#21C25E', imageUrl: 'https://cdn.simpleicons.org/picpay/21C25E' },
    { id: 'mp', name: 'Mercado Pago', color: '#009EE3', imageUrl: 'https://cdn.simpleicons.org/mercadopago/009EE3' },
