...
import { format, startOfMonth, endOfMonth, startOfYear, isSameMonth, addYears, subYears, startOfDay, endOfDay, subDays, isWithinInterval } from 'date-fns'
...
export function MonthTabs({ 
    ...
    const hasFilters = filterType !== 'ALL' || (filterAccount !== '__ALL__' && filterAccount !== '')
