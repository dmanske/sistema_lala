...
- [x] 1. Database schema and migration setup
  - [x] 1.1 Create bank_accounts table migration
  ...
  - [x] 1.2 Add bank_account_id column to cash_movements
  ...
  - [x] 1.3 Create default account migration
...
- [x] 2. Domain models and types
  - [x] 2.1 Create BankAccount domain model
  ...
  - [x] 2.2 Update CashMovement domain model
    - Update src/core/domain/CashMovement.ts
    - Add bankAccountId field (required)
    - Update type definitions
    - _Requirements: 4.1, 4.4_

- [x] 3. Repository interface and implementation
  - [x] 3.1 Create BankAccountRepository interface
  ...
  - [x] 3.2 Implement SupabaseBankAccountRepository
  ...
  - [x] 3.3 Implement balance calculation methods
  ...
  - [x] 3.4 Implement hasMovements validation method
...
- [x] 4. Use cases implementation
  - [x] 4.1 Implement CreateBankAccountUseCase
  ...
  - [x] 4.3 Implement UpdateBankAccountUseCase
  ...
  - [x] 4.5 Implement DeactivateBankAccountUseCase
  ...
  - [x] 4.7 Implement ListBankAccountsUseCase
  ...
  - [x] 4.9 Implement GetAccountStatementUseCase
...
- [x] 5. Update cash movement system
  - [x] 5.1 Update CashMovementRepository interface
  ...
  - [x] 5.2 Update SupabaseCashMovementRepository implementation
...
- [x] 6. Update database RPC functions
  - [x] 6.1 Update pay_sale function
  ...
  - [x] 6.2 Update create_purchase_with_movements function
  ...
  - [x] 6.3 Update add_client_credit function
...
- [x] 8. UI components - Account selector
  - [x] 8.1 Create AccountSelector component
...
- [x] 9. UI components - Account list and management
  - [x] 9.1 Create BankAccountsList component
  ...
  - [x] 9.2 Create BankAccountDialog component
...
- [x] 10. UI components - Account statement
  - [x] 10.1 Create AccountStatementView component
...
- [x] 11. Pages - Bank accounts management
  - [x] 11.1 Create bank accounts list page
  ...
  - [x] 11.2 Create account detail/statement page
...
- [x] 12. Update payment flows - Sales checkout
  - [x] 12.1 Update PaymentDialog component
...
- [x] 13. Update payment flows - Purchases
  - [x] 13.1 Update purchase payment form
...
- [x] 14. Update payment flows - Client credit recharge
  - [x] 14.1 Update credit recharge dialog
...
- [x] 15. Update payment flows - Manual cash movements
  - [x] 15.1 Update manual cash movement dialog
...
- [x] 16. Update cash movements display
  - [x] 16.1 Update cash movements list to show account
...
- [x] 17. Navigation and routing
  - [x] 17.1 Add bank accounts to navigation menu
